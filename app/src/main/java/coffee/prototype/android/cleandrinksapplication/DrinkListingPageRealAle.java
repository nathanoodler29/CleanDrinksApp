...
public class DrinkListingPageRealAle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //References real ale  toolbar
        Toolbar myToolbar = (Toolbar) findViewById(R.id.real_ale_tool_bar);
        ...
        //Searches through the drinks array list for drinks of type real ale and places these values in mAdapter
