...
public class DrinkListingPageStout extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //References stout  toolbar
        Toolbar myToolbar = (Toolbar) findViewById(R.id.stout_tool_bar);
        ...
        //Searches through the drinks array list for drinks of type stout and places these values in mAdapter
